...
public class TestContentStream extends BaseTest {
    ...
    public void testEmbeddedIndexFile() throws SolrServerException{
    ...
    public void testDateRangQuery() throws SolrServerException{
        //1976-03-06T23:59:59.999Z
        this.execute("testDateRangQuery", "TestDate:[2010-01-05T00:00:00Z TO 2010-01-07T00:00:00Z]");
    }
    public void testNumberRangQuery() throws SolrServerException{
        
        this.execute("testNumberRangQuery", "testnumber:[4 TO 5] ");
    }
  public void testLongNumberRangQuery() throws SolrServerException{
